...
<html lang="zh-CN">                                                                                                                        
  ...
  <form class="form-horizontal"   action="${pageContext.request.contextPath }/speaker/addSpeaker02.action">
  <div class="form-group">
  	 <label for="inputEmail3" class="col-sm-2 control-label">名字</label>
   		<div class="col-sm-10" style="width: 600px;">
          <input type="text" class="form-control" id="inputPassword3"  name="speakerName"     placeholder="请填写名称">
        </div>
  	</div>
   ...
   <div class="form-group">
  	 <label for="inputEmail3" class="col-sm-2 control-label">职业</label>
   		<div class="col-sm-10" style="width: 600px;">
          <input type="text" class="form-control" id="inputPassword3" name="speakerJob" placeholder="请填写职业">
        </div>
  	</div>
    ...
    <div class="form-group">
  	 <label for="inputEmail3" class="col-sm-2 control-label">头像照片</label>
   		<div class="col-sm-10" style="width: 600px;">
          <input type="text" class="form-control" id="inputPassword3"  name="speakerHeadUrl"   placeholder="头像照片">
        </div>
  	</div>
    ...
    <div class="form-group">
  	 <label for="inputEmail3" class="col-sm-2 control-label">视频简介</label>
   		<div class="col-sm-10" style="width: 600px ;  height: 30px;">
   			<textarea  class="form-control" id="inputPassword3" placeholder="视频简介"   name="speakerDescr"></textarea>
        </div>
  	</div>
