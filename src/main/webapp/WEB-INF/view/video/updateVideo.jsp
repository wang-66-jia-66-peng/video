...
<html lang="zh-CN">                                                                                                                        
  ...
  <form class="form-horizontal"  action="${pageContext.request.contextPath }/video/updateVideo02.action"  >
  <div class="form-group">
  	 <label for="inputEmail3" class="col-sm-2 control-label">视频标题</label>
   		<div class="col-sm-10" style="width: 600px;">
          <input type="text" class="form-control" id="inputPassword3" placeholder="视频标题"    name="videoTitle"    value="${video.videoTitle }">
        </div>
  	</div>
   ...
   <div class="form-group">
  	 <label for="inputEmail3" class="col-sm-2 control-label">视频时长</label>
   		<div class="col-sm-10" style="width: 600px;">
          <input type="text" class="form-control" id="inputPassword3" placeholder="视频时长"   name="videoLength"   value="${video.videoLength }">
        </div>
  	</div>
    ...
    <div class="form-group">
  	 <label for="inputEmail3" class="col-sm-2 control-label">图片封面</label>
   		<div class="col-sm-10" style="width: 600px;">
          <input type="text" class="form-control" id="inputPassword3" placeholder="图片封面"   name="videoImageUrl"   value="${video.videoImageUrl }">
        </div>
  	</div>
   ...
   <div class="form-group">
  	 <label for="inputEmail3" class="col-sm-2 control-label">视频播放地址</label>
   		<div class="col-sm-10" style="width: 600px;">
          <input type="text" class="form-control" id="inputPassword3" placeholder="视频播放地址" name="videoUrl"    value="${video.videoUrl }">
        </div>
  	</div>
    ...
    <div class="form-group">
  	 <label for="inputEmail3" class="col-sm-2 control-label">视频简介</label>
   		<div class="col-sm-10" style="width: 600px ;  height: 30px;">
   			<textarea  class="form-control" id="inputPassword3" placeholder="视频简介"   name="videoDescr"  >${video.videoDescr }</textarea>
        </div>
  	</div>
