                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <div class="profile_ifo_area">
                            <form action="${pageContext.request.contextPath}/front/user/profile02.action" method="post">
                                ...
                                <div class="form_group">
                                    ...
                                    <input type="date"  name="birthdayStr" value="<fmt:formatDate value='${user.birthday}' pattern="YYYY-MM-dd"></fmt:formatDate>">
                                </div>
                                <div class="form_group">
