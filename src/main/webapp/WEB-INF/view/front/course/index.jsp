...
<body class="w100">
	...
	<div id="app">
		<!--banner图-->
		<div class="banner"
			style="background-image: url('/video/static/img/banner-${subject.id}.jpg')"></div>
							...
							<div class="thum" style="background-image: url(${video.videoImageUrl})"></div>
								...
								<div class="classify-v-info">
									...
									<span class="duration" title="视频时长">
										<img src="${pageContext.request.contextPath }/static/img/player.png" alt="">${video.CName }</span>
								</div>
							</li>
						</c:forEach>
					</ul>
